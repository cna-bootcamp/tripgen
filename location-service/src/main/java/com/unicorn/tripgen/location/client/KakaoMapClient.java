...
interface KakaoMobilityClient {
     ...
     * @return 대중교통 경로 정보
     */
    @GetMapping("/v1/directions/transit")
     ...
     * @return 보행자 경로 정보
     */
    @GetMapping("/v1/directions/walk")
    Map<String, Object> getWalkingDirections(
        @RequestHeader("Authorization") String authorization,
        @RequestParam("origin") String origin,
        @RequestParam("destination") String destination
    );
